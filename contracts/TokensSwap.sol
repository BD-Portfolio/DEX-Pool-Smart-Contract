...
contract TokensSwap is IUniswapV2CustomRouter, Ownable {
    ...
    uint public wieAppFees;
    uint public wieAppFeesDecimals;
     ...
     * @notice constructor initializes sushiswap and fees contracts
       ...
       @param _decimals decimals for wie app fees fraction value
    ...
    */
    ...
    /**
     *
     * @notice modifies the wie app fees and can be called by contract owner only
       @notice zero's appended in the last of input number represents decimal places
       @param fees fees percent to be dedcuted from transaction of user
       @param decimals decimals for wie app fees fraction value
    */
    function setWieAppFees(
        uint fees,
        uint decimals
    ) external onlyOwner() onlyValidFees(fees, decimals) {
        require(
            fees != wieAppFees || 
            decimals != wieAppFeesDecimals, 
            "Already same fee used!"
        );        
        wieAppFees = fees;
        wieAppFeesDecimals = decimals;
    }
    ...
    */
    ...
    /**
     *
     * @notice updates discount rates for wie token holders, only owner allowed
    ...
    */
     ...
     * @notice checks the parameters whether valid for swap or not
       ...
       @param ethAsFee amount as wie app fees for swap
    */
    ...
    */
    ...
    /**
     *
     * @notice calculates wie app for some amount of input tokens provided by 
       the user to swap
       @return wieAppFee wie app fee to be charged from for swapping
    ...
    */
    function calculateFeesForTransaction(
        ...
        wieAppFee = (amount * wieAppFees * (100 - discountPercent)) / (wieAppFeesDecimals * 100 * 100);
    }
